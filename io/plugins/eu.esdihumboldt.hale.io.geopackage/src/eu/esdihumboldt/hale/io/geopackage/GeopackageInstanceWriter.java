...
//			geoPackage.beginTransaction(); //XXX not sure how to use this -> results in a SQL exception later on (SQLITE_BUSY)
...
//			geoPackage.endTransaction();
	...
	private GeopackageTableType createTableIfNecessary(GeoPackage geoPackage, String tableName,
		...
		// TODO filter out complex properties w/ HasValue or AugmentedValue?
